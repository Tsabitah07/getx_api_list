                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            IconButton(
                                onPressed: () {
                                  watchlist.watchlist.contains(id)
                                      ?watchlist.removeFromFavorite(id)
                                      :watchlist.addToFavorite(id);
                                },
                                icon: Obx((){
                                  if(watchlist.watchlist.contains(id)){
                                    return Icon(
                        ...
                        child: Column(
                          ...
                          children: [
                            Obx((){
                              if(controller.movies[index].adult == controller.isAdult.value){
                                return Text(
                                  ...
                                  style: BodyTextStyle(/*17, primaryTextColor*/),
                                );
                              } else {
                                return Text(
                                  "Rating Usia: 18+",
                            ...
                            Text(
                              ...
                              style: BodyTextStyle(/*15, secondaryTextColor*/),
                              maxLines: 10,
                              overflow: TextOverflow.ellipsis,
                            )
                          ],
